                                        ...
                                        <div class="slogan container container--90">
                                            <div class="slogan--item">
                                                ...
                                                <div class="slogan--steps">
                                                    <div class="slogan--steps-title"><spring:message
                                                            code="text.4steps"/></div>
                                                    <ul class="slogan--steps-boxes">
                                                        <li>
                                                            <div><em>1</em><span><spring:message
                                                                    code="text.chooseItems"/></span></div>
                                                        </li>
                                                        <li>
                                                            <div><em>2</em><span><spring:message
                                                                    code="text.putInBags"/></span></div>
                                                        </li>
                                                        <li>
                                                            <div><em>3</em><span><spring:message
                                                                    code="text.chooseInstitution"/></span></div>
                                                        </li>
                                                        <li>
                                                            <div><em>4</em><span><spring:message
                                                                    code="text.orderCourier"/></span></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
