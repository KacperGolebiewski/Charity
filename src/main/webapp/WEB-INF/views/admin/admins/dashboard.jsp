    ...
    <div class="container py-5">
        <div class="card mb-4">
            <div class="card-header px-4 py-3 custom-display">
                <span><strong><spring:message code="text.manageAdmins"/></strong></span>
                ...
                <div class="tab-content rounded-bottom">
                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1055">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <th scope="col">
                                    <a href="<c:url value="/admin/dashboard/${currentPage}?sortField=firstName&sortDir=${reverseSortDir}"/>"><i
                                            class="fa fa-fw fa-sort"></i></a>
                                    <span><spring:message code="text.firstName"/></span>
                                </th>
                                <th scope="col">
                                    <a href="<c:url value="/admin/dashboard/${currentPage}?sortField=lastName&sortDir=${reverseSortDir}"/>"><i
                                            class="fa fa-fw fa-sort"></i></a>
                                    <span><spring:message code="text.lastName"/></span>
                                </th>
                                <th scope="col">
                                    <a href="<c:url value="/admin/dashboard/${currentPage}?sortField=email&sortDir=${reverseSortDir}"/>"><i
                                            class="fa fa-fw fa-sort"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <a style="font-size: 1.5rem;!important;"
                                           ...
                                           href="<c:url value="/admin/dashboard/confirm-delete/${admin.id}"/>"><i
                                        ...
                                        <a style="font-size: 1.5rem;!important;"
                                           ...
                                           href="<c:url value="/admin/dashboard/edit/${admin.id}"/>"><i
                ...
                <ul class="pagination justify-content-center">
                    <c:choose>
                        <c:when test="${currentPage > 1}">
                            <li class="page-item">
                                <a class="page-link"
                                   href="<c:url value="/admin/dashboard/${currentPage-1}?sortField=${sortField}&sortDir=${sortDir}"/>"><spring:message code="text.previous"/></a>
                            </li>
                        </c:when>
                        <c:otherwise>
                        ...
                        <c:choose>
                            <c:when test="${currentPage != status.index}">
                                <li class="page-item"><a class="page-link"
                                                         href="<c:url value="/admin/dashboard/${status.index}?sortField=${sortField}&sortDir=${sortDir}"/>">${status.index}</a>
                                </li>
                            </c:when>
                            <c:otherwise>
                    ...
                    <c:choose>
                        <c:when test="${currentPage < totalPages}">
                            <li class="page-item">
                                <a class="page-link"
                                   href="<c:url value="/admin/dashboard/${currentPage+1}?sortField=${sortField}&sortDir=${sortDir}"/>"><spring:message code="text.next"/></a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li class="page-item disabled">
