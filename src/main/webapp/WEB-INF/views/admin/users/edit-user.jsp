        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group form-group--checkbox">
                    ...
                    <label>
                        <form:checkbox path="enabled" cssClass="checkbox" value="${user.enabled}" id="enabled"/><span class="description"></span>
                    </label>
                </div>
                    <div class="form-group form-group--checkbox">
                        <div class="title">Zablokowany</div>
                        <label>
                            <form:checkbox path="locked" cssClass="checkbox" value="${user.locked}" id="locked"/><span class="description"></span>
                        </label>
                    </div>
                <div class="form-group ">
